...
from lusid_configuration.api_client import ApiClient as AsyncApiClient
...
import lusid_configuration.extensions.retry as retry
from lusid_configuration.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_configuration.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for lusid_configuration if needed
