...
from finbourne_configuration.api_client import ApiClient as AsyncApiClient
...
from finbourne_configuration.configuration import Configuration
import finbourne_configuration.extensions.retry as retry
from finbourne_configuration.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_configuration.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_configuration if needed
